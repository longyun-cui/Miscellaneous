...
use App\Repositories\Dongkai\Admin\MessageRepository;
...
class MessageController extends Controller
{
    ...
    {
        return view('dongkai.admin.message.index');
    }

    public function viewList()
    {
        if(request()->isMethod('get')) return view('dongkai.admin.message.list');
