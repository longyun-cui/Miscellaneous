...
use App\Repositories\Dongkai\Admin\ModuleRepository;
...
class ModuleController extends Controller
{
    ...
    {
        return view('dongkai.admin.module.index');
    }

    public function viewList()
    {
        if(request()->isMethod('get')) return view('dongkai.admin.module.list');
