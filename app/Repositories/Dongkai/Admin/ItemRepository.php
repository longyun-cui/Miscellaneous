...
class ItemRepository {
    ...
    public function view_create()
    {
        ...
        if($category == 'info') $view_blade = 'dongkai.admin.item.edit-info';
        elseif($category == 'about') $view_blade = 'dongkai.admin.item.edit-about';
        elseif($category == 'advantage') $view_blade = 'dongkai.admin.item.edit-advantage';
        elseif($category == 'cooperation') $view_blade = 'dongkai.admin.item.edit-cooperation';
        elseif($category == 'rent-out') $view_blade = 'dongkai.admin.item.edit-rent-out';
        elseif($category == 'second-wholesale') $view_blade = 'dongkai.admin.item.edit-second-wholesale';
        elseif($category == 'recycling') $view_blade = 'dongkai.admin.item.edit-recycling';
        elseif($category == 'faq') $view_blade = 'dongkai.admin.item.edit-faq';
        elseif($category == 'coverage') $view_blade = 'dongkai.admin.item.edit-coverage';
        elseif($category == 'activity') $view_blade = 'dongkai.admin.item.edit-activity';
        elseif($category == 'client') $view_blade = 'dongkai.admin.item.edit-client';
        else $view_blade = 'dongkai.admin.item.edit';
    ...
    public function view_edit()
    {
        ...
        if($decode_id == 0)
        {
            return view('dongkai.admin.item.edit')->with(['operate'=>'create', 'encode_id'=>$id]);
        }
        else
        {
            $menus = RootMenu::get();
            ...
            if($mine)
            {
                ...
                if($category == '1') $view_blade = 'dongkai.admin.item.edit-info';
                elseif($category == '2') $view_blade = 'dongkai.admin.item.edit-about';
                elseif($category == '5') $view_blade = 'dongkai.admin.item.edit-advantage';
                elseif($category == '9') $view_blade = 'dongkai.admin.item.edit-cooperation';
                elseif($category == '11') $view_blade = 'dongkai.admin.item.edit-rent-out';
                elseif($category == '12') $view_blade = 'dongkai.admin.item.edit-second-wholesale';
                elseif($category == '19') $view_blade = 'dongkai.admin.item.edit-recycling';
                elseif($category == '31') $view_blade = 'dongkai.admin.item.edit-faq';
                elseif($category == '41') $view_blade = 'dongkai.admin.item.edit-coverage';
                elseif($category == '48') $view_blade = 'dongkai.admin.item.edit-activity';
                elseif($category == '51') $view_blade = 'dongkai.admin.item.edit-client';
                else $view_blade = 'dongkai.admin.item.edit';
