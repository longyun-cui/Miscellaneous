...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include('dongkai.admin.component.main-header')

    {{--main-sidebar--}}
    @include('dongkai.admin.component.main-sidebar')

    {{--main-content--}}
    @include('dongkai.admin.component.main-content')

    {{--main-footer--}}
    @include('dongkai.admin.component.main-footer')

    {{--control-sidebar--}}
    @include('dongkai.admin.component.control-sidebar')
