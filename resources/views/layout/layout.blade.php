            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/admin/company/index')}}"><i class="fa fa-circle-o text-red"></i>企业信息</a></li>
                        <li><a href="{{url('/admin/company/edit')}}"><i class="fa fa-circle-o text-red"></i>首页编辑</a></li>
                        <li><a href="{{url('/admin/company/product/list')}}"><i class="fa fa-circle-o text-aqua"></i>产品列表</a></li>
                    </ul>
                </li>
                <li class="active">
                    <a href="/tools"><i class="fa fa-link"></i> <span>Tools</span></a>
                </li>
                <li>
